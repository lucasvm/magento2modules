...
namespace Lansadigital\Featuredhome\Block\Home;

use Magento\Catalog\Api\CategoryRepositoryInterface;

class FeaturedHome extends \Magento\Catalog\Block\Product\ListProduct {
    ...
    public function getProducts() {
        ...
        if(isset($category) && $category) {
            $collection->addMinimalPrice()
                ...
                ->addAttributeToFilter('ls_featurdhome', 1, 'left')
